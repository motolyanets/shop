    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customerName', models.CharField(blank=True, default=None, max_length=128)),
                ('customerEmail', models.EmailField(blank=True, default=None, max_length=254)),
                ('customerPhone', models.CharField(blank=True, default=None, max_length=48)),
